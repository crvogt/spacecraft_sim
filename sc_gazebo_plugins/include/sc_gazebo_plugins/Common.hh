...
//
// The original code was modified by the SC Authors to adhere to
// Gazebo's coding standards.

#ifndef SC_SENSOR_PLUGINS_COMMON_H_
#define SC_SENSOR_PLUGINS_COMMON_H_
                 ...
                 const T& default_value, const bool& verbose = false)
{
  ...
  else
  {
    param = default_value;
    if (verbose)
      gzerr << "[sc_sensor_plugins] Please specify a value for parameter \""
            << name << "\".\n";
  }
  return false;
}
