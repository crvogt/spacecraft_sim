...
class MoveGroupPythonInterface(object):
    def __init__(self):
        ...
        self.panel_sub = rospy.Subscriber('tag_detections', AprilTagDetectionArray, self.get_panel_CB)
        ...
        self.panel_msg = AprilTagDetectionArray
        ...
        print("Sleeping for a couple seconds...")
        rospy.sleep(2)

    def get_state_CB(self, _data):
        self.get_state_msg = _data

    def get_panel_CB(self, _data):
        self.panel_msg = _data
